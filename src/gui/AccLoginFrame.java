...
public class AccLoginFrame extends JFrame {
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == 10) {
					...
					int lid = acc.signin(textField.getText().toString(),
							passwordField.getText().toString());
					try {
						if (lid != -1) {
							AccountantMainFrame accObj = new AccountantMainFrame();
							accObj.setVisible(true);
							dispose();
						} else {
